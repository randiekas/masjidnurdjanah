...
<div>
	...
	<v-container style="margin-top:-180px;" class="teal lighten-5">
		<v-card flat color="transparent">
			<h1 class="white--text text-h4">TahfidzDigital</h1>
			<p class="white--text">Free online tools for helping to memorize the Qur'an</p>
		</v-card>
		<v-card>
	...
	<v-row>
		...
		<v-col cols="12"
			v-if="surat.length>0">
			<p class="text-overline mb-0">LAST MEMORIZED</p>
			<v-card 
				dark 
				color="primary"
		...
		<v-col cols="12">
			<p class="text-overline mb-0">Tool number 2 ( just choose the surah )</p>
			<v-row dense>
				<v-col 
...
export default {
	...
	mounted: function(){
		...
		if(this.step===1){
			percakapan = [
				'Assalamualaykum ... 😊',
				'Selamat datang di tahfidzdigital',
				"Apa itu tahfidz digital ? <br/><br/>Tahfidzdigital adalah aplikasi untuk membantu kamu menghafal ayat-ayat Al- Qur'an",
